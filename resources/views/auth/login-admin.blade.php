...
<div class="login-container">
    <div class="login-left">
        <div class="branding">
            ...
            <h1 class="headline">
                SISTEM <span class="highlight">ADMINISTRASI</span><br>
                TERPADU.
            </h1>
            <p class="desc">Platform manajemen layanan akademik Universitas Muhammadiyah Surakarta khusus untuk staf biro dan administrator.</p>
            <div class="features">
                <div class="feature-with-bar">
                    <div class="vertical-bar"></div>
                    <div>
                        <span class="feature-value">KEAMANAN TINGGI</span><br>Akses dipantau ketat
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="login-right">
        <h2 class="welcome">ADMIN LOGIN</h2>
        <p class="subtitle">Gunakan kredensial resmi staf untuk mengakses dashboard manajemen.</p>
        <div class="role-tabs">
            ...
            <button class="tab active" type="button"><span class="tab-icon">🛡️</span>ADMIN</button>
        </div>
        <form class="login-form" onsubmit="return false;">
            ...
            <div class="input-group">
                ...
                <input type="text" id="nip" name="nip" placeholder="Masukkan ID Pegawai" required>
            </div>
            <label for="password" class="form-label">KATA SANDI <a href="#" class="forgot">Lupa Password?</a></label>
            ...
            <button type="submit" class="btn-login">Login ke Sistem <span style="font-size:1.3em;vertical-align:-2px;">→</span></button>
        </form>
        <div class="divider"></div>
        <div class="no-account">
            <button class="btn-contact">Bantuan IT</button>
        </div>
        ...
        document.querySelectorAll('.tab').forEach(tab => {
            tab.addEventListener('click', function() {
                if (this.textContent.includes('MAHASISWA')) {
                    window.location.href = '/';
                } else if (this.textContent.includes('DOSEN')) {
...
@vite(['public/css/login-admin.css'])
