        ...
        <div class="branding">
            ...
            <div class="features">
                <div class="feature-with-bar">
                    ...
                    <div><span class="feature-value">KEAMANAN TINGGI</span><br>Akses dipantau ketat</div>
                </div>
            </div>
        </div>
    </div>
    <div class="login-right">
        ...
        <form class="login-form" method="POST" action="{{ url('login/admin') }}">
            ...
            <div class="input-group">
                ...
                <input type="email" id="email" name="email" placeholder="admin@tu.ac.id" value="{{ old('email') }}" required>
            </div>
        ...
        <div class="no-account"><button class="btn-contact">Bantuan IT</button></div>
        ...
        document.querySelectorAll('.tab').forEach(tab => {
            tab.addEventListener('click', function() {
                ...
                else if (this.textContent.includes('DOSEN')) window.location.href = '/login/dosen';
            });
        });
        </script>
    </div>
