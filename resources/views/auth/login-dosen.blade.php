...
<div class="login-container">
        ...
        <div class="branding">
            ...
            <div class="features">
                <div class="feature-with-bar">
                    ...
                    <div>
                        <span class="feature-value">SECURE AUTHENTICATION</span><br>NIDN INTEGRATED
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="login-right">
        ...
        <form class="login-form" onsubmit="return false;">
            <label for="nidn" class="form-label">NIDN / EMAIL INSTITUSI</label>
            <div class="input-group">
                ...
                <input type="text" id="nidn" name="nidn" placeholder="0627018801" required>
            </div>
            ...
            <button type="submit" class="btn-login">Masuk Sekarang <span style="font-size:1.3em;vertical-align:-2px;">→</span></button>
        </form>
